...
Site web de la Cab'âne basé sur https://github.com/LeNPaul/Millennial.

Le rédactionnel est dans le dossier _posts.

L'ordre des pages sur la page d'accueil est défini par la date (cf les noms de fichiers).

L'ordre et l'affichage des pages dans le menu est défini dans le fichier _data/settings.yml.

Les photos sont dans le dossier assets/img.

Le menu, header et footer de page est auto-généré.

Le contenu des pages est rédigé en markdown (cf ci-dessous).
